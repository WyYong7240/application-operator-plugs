...
```sh
make docker-build docker-push IMG=<some-registry>/application-operator-plus:tag
```
...
```sh
make deploy IMG=<some-registry>/application-operator-plus:tag
```
